...
(function (h) {
	...
	m.defaults = {
		...
		oLanguage: {
			...
			sInfo: "نمایش _START_ تا _END_ از _TOTAL_ لیست",
			sInfoEmpty: "نمایش 0 تا 0 از لیست",
			sInfoFiltered: "(فیلتر شده از مجموعه _MAX_ ورودی)",
			sInfoPostFix: "",
			sDecimal: "",
			sThousands: ",",
			sLengthMenu: "نمایش _MENU_ ورودی",
			sLoadingRecords: "در حال باز کردن...",
			sProcessing: "در حال پردازش اطلاعات...",
			sSearch: "جستجو: ",
			sSearchPlaceholder: "",
			sUrl: "",
			sZeroRecords: "کدام اطلاعاتی یافت نشد...",
		},
