 ...
 * KamaDatepicker
 * Version: 1.4.3
 * Copyright Â© 2016 Hadi Kefayati | MIT license
...
var kamaDatepicker = function (elementID, opt) {
    ...
    var FA_NUMS = ['Ù ', 'Ù¡', 'Ù¢', 'Ù£', 'Û´', 'Ûµ', 'Û¶', 'Ù§', 'Ù¨', 'Ù©', 'Ù¡Ù ', 'Ù¡Ù¡', 'Ù¡Ù¢', 'Ù¡Ù£', 'Ù¡Û´', 'Ù¡Ûµ', 'Ù¡Û¶', 'Ù¡Ù§', 'Ù¡Ù¨', 'Ù¡Ù©', 'Ù¢Ù ', 'Ù¢Ù¡', 'Ù¢Ù¢', 'Ù¢Ù£', 'Ù¢Û´', 'Ù¢Ûµ', 'Ù¢Û¶', 'Ù¢Ù§', 'Ù¢Ù¨', 'Ù¢Ù©', 'Ù£Ù ', 'Ù£Ù¡', 'Ù£Ù¢'];
    ...
    titleDiv.append("<button id='bd-next-" + elementID + "' class='bd-next' type='button' title='Ù…Ø§Ù‡ Ø¨Ø¹Ø¯ÛŒ' data-toggle='tooltip'><span>Ø¨Ø¹Ø¯ÛŒ</span></button>");
    ...
    titleDiv.append("<button id='bd-prev-" + elementID + "' class='bd-prev' type='button' title='Ù…Ø§Ù‡ Ù‚Ø¨Ù„ÛŒ' data-toggle='tooltip'><span>Ù‚Ø¨Ù„ÛŒ</span></button>");
    ...
    if (options.gotoToday) {
        calendarDiv.append("<div class='bd-goto-today'>Ø¨Ø±Ùˆ Ø¨Ù‡ Ø§Ù…Ø±ÙˆØ²</div>");
